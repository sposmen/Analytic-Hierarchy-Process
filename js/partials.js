...
'        <td>',
'          <select ng-options="value as fraction for (fraction, value) in fractions" ng-model="parentFactor.pairwise[$parent.$index][$index]" class="form-control"></select>',
'        </td>',
'      </tr>',
'    </tbody>',
'  </table>',
...
'  <!--  tr-->',
'  <!--    th Factor-->',
'  <!--    th.text-center Seleccione que tan importante es un factor-->',
'  <!--      br frente al otro-->',
'  <!--    th Factor-->',
'  <!--  tbody(ng-repeat=\'factorRow in factors\')-->',
'  <!--    tr(ng-repeat=\'factorColumn in factors\', ng-show="$index > $parent.$index")-->',
...
'        <td ng-bind="factorRow.name + \' sobre \' + factorColumn.name "></td>',
'        <td>',
'          <select ng-options="value as fraction for (fraction, value) in fractions" ng-model="parentFactor.pair_wise_options[$parent.$parent.$index][$parent.$index][$index]" class="form-control"></select>',
'        </td>',
'      </tr>',
'    </tbody>',
'  </table>',
