...
'    <input type="text" ng-model="parentFactor.meta" class="form-control">',
'  </div>',
'  <div ng-hide="!!parentFactor.parent" class="options">',
'    <h3>Ingrese los Proyectos/Opciones a evaluar en el objetivo.',
'      <button ng-click="addOption()" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Opción</button>',
'    </h3>',
'    <div class="row-fluid">',
'      <table class="table">',
'        <tr>',
...
'    <button ng-click="addFactor()" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Factor</button>',
'  </h3>',
...
'        <td ng-bind="$index + 1"></td>',
'        <td>',
'          <input type="text" ng-model="factor.name" class="form-control">',
'        </td>',
'      </tr>',
'    </table>',
'  </div>',
...
'        <td ng-bind="factorRow.name" class="text-right"></td>',
'        <td class="text-center">',
'          <select ng-options="value as fraction for (fraction, value) in fractions" ng-model="parentFactor.pairwise[$parent.$index][$index]" class="options-centered form-control"></select>',
'        </td>',
'        <td ng-bind="factorColumn.name"></td>',
'      </tr>',
'    </tbody>',
'  </table>',
'  <div ng-show="$root.show_process" class="process">',
...
'    <thead>',
'      <tr>',
'        <th class="text-right">Proyecto/Opción</th>',
'        <th class="text-center">Comparación sobre<span ng-bind="\' \' + factor.name"></span></th>',
...
'        <td ng-bind="factorRow.name" class="text-right"></td>',
'        <td class="text-center">',
'          <select ng-options="value as fraction for (fraction, value) in fractions" ng-model="parentFactor.pair_wise_options[$parent.$parent.$index][$parent.$index][$index]" class="options-centered form-control"></select>',
'        </td>',
'        <td ng-bind="factorColumn.name"></td>',
'      </tr>',
'    </tbody>',
